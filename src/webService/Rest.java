...
public class Rest extends HttpServlet {
	...
	/**
	 * URL http://127.0.0.1:8080//Backend/ws/rest/market/transmit JSON input {
	 * "id_market": 1, "id_product": 1, "quantity": 100 } JSON output { "result":
	 * "success" }
	 */
	@POST
...
//TODO /get data from DB
			res.getSupermarket().add(new SupermarketItem(0, "REWA Center Bad Nauheim", "Bad Nauheim",
					"Georg-Scheller-Strasse 2-8", "8.754167", "50.361944"));
...
//TODO get data from DB, now just one test record
	 ...
	 * @HEAD
	 * 
	 * @Path("/product/manage") public Response
	 * productManageHead(@QueryParam("param1") String param1) { Response response =
	 * Response.ok("this body will be ignored") .header("someHeader",
	 * "someHeaderValue") .build(); return response; }
	 */
	/**
